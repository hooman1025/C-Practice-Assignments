...
class Function {
public:
    static std::string binaryCalculator(const std::string& inputFirstBinary, 
    ...
    static void pushBackBinary(const std::string& inputFirstBinary, std::vector<char>& firstBinary, 
